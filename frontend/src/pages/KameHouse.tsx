...
/**
 * KameHouse (Family Hub) - Phase 3 Redesign
 * Implements Moksart UX recommendations:
 * - Card-based scrollable layout (no tabs)
 * - ActiveNow widget for household pulse
 * - Progressive disclosure (top 3 items, expand for more)
  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ minHeight: '100vh', py: 4 }}>
        ...
        {/* Active Now Widget - Moksart UX Enhancement */}
        <ActiveNowWidget
        ...
        <Card id="lets-economy-section" sx={{ mb: 3 }}>
          <CardContent>
            ...
            {balance && (
              <Box sx={{ mb: 3, p: 2, bgcolor: balance.isInDebt ? 'error.light' : 'success.light', borderRadius: 2 }}>
                <Typography variant="body2" color="text.secondary">
                  Your Balance
                </Typography>
                <Typography variant="h4" fontWeight="bold">
                  {balance.balance > 0 ? '+' : ''}{balance.balance} credits
                </Typography>
              </Box>
            )}
